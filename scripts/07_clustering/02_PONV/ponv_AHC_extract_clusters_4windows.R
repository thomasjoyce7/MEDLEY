...
ahc_settings <- list(optimal_k=8, n_pcs=5, center=TRUE, scale=FALSE, omit_first_pc = FALSE)
...
save_clusters <- function(embedding_name, all_clustering_results, subject_id) {
  ...
  output_path <- file.path(
    "data/cohorts/02_PONV/AHC_clusters_4windows/",
    paste0(
      "ponv_ahc_4windows_", embedding_name,
