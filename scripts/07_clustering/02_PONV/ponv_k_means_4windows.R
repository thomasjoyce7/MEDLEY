# k-means++ clustering for the PONV application
...
elbow_method_output_path <- file.path(
  "figures/clustering/02_PONV/k_means",
  paste0("ponv_kmeans_elbow_method_grid_4windows_", elbow_method_suffix, ".pdf")
)

elbow_method_long_seq_encoders_output_path <- file.path(
  "figures/clustering/02_PONV/k_means",
  paste0("ponv_kmeans_elbow_method_grid_long_seq_encoders_4windows_", elbow_method_suffix, ".pdf")
)

clustering_suffix <- encode_kmeans_clustering_settings(k_means_settings)
clustering_output_path <- file.path(
  "data/results/clustering/02_PONV/k_means",
  paste0("ponv_kmeans_results_4windows_", clustering_suffix, ".csv")
)
...
if (run_elbow_method == TRUE){
  ...
  # Save elbow plots for long sequence encoders only
