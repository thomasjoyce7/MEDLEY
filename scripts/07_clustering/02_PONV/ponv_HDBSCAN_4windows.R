# HDBSCAN clustering for the PONV application
...
hdbscan_settings <- list(n_pcs=5, omit_first_pc=FALSE, center=TRUE, scale=FALSE, minPts=250)
...
clustering_output_path <- file.path(
  "data/results/clustering/02_PONV/HDBSCAN",
  paste0("ponv_hdbscan_results_4windows_", clustering_suffix, ".csv")
)
