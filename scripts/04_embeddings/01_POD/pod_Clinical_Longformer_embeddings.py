# Script to calculate the embeddings for all templates using Clinical-Longformer
...
for input_path in input_paths:
    ...
    # Save as a csv file
    output_path = os.path.join(paths["embeddings"], f"clinical_longformer_{template_name}_embeddings3.csv")
