# Script to calculate embeddings for all templates using SFR-Embedding-Mistral
# Huggingface model card: https://huggingface.co/Salesforce/SFR-Embedding-Mistral
...
# -----------------------------------------------------------------------------
# Pooling helper for SFR-Embedding-Mistral
# -----------------------------------------------------------------------------
...
def compute_embeddings(input_path, batch_size=BATCH_SIZE, max_length=MAX_LENGTH):
    """
    Compute SFR embeddings for all records in a JSONL file.
...
# -----------------------------------------------------------------------------
print("Processing SFR embeddings.")
...
for input_path in input_paths:
    ...
    output_path = os.path.join(
        paths["embeddings"],
        f"SFR_embedding_mistral_{template_name}.csv"
    )
