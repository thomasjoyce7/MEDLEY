# Make and save PONV clustering results (4 windows) tables in latex format for the manuscript
...
# Load clustering results (50 repetitions; 5pcs, centered and unscaled; global mean pooling)
kmeans_results <- read_csv("data/results/clustering/02_PONV/k_means/ponv_kmeans_results_4windows_50rep_5pcs_centered_unscaled_8clusters.csv")
gmm_results <- read_csv("data/results/clustering/02_PONV/GMM/ponv_gmm_results_4windows_50rep_5pcs_centered_unscaled_8clusters.csv")
hdbscan_results <- read_csv("data/results/clustering/02_PONV/HDBSCAN/ponv_hdbscan_results_4windows_5pcs_centered_unscaled_250minPts.csv")
ahc_results <- read_csv("data/results/clustering/02_PONV/AHC/ponv_ahc_results_4windows_5pcs_centered_unscaled_8clusters.csv")
...
save_kable(kbl, "tables/02_PONV/ponv_clustering_results_pca5d_centered_unscaled_4windows.tex")
