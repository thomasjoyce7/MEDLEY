# Make and save POD clustering results tables in latex format for the manuscript
...
df_kmeans  <- process_df(mp_pca_kmeans_2_center, "K-means++")
df_gmm     <- process_df(mp_pca_gmm_2_center,    "GMM")
df_hdbscan <- process_df(mp_pca_hdbscan_2_center,"HDBSCAN")
df_ahc     <- process_df(mp_pca_ahc_2_center,    "AHC")
